...
# params
#     area
#         line 1-dim  list len(4)/int
#         pan  1-dim  list len(4)/int
#     template
#         wid_patch_r, wid_patch_c /float
#         dis_r, dis_c /float
#         mean_gray_r, mean_gray_c /float
...
class Locate(object):
    ...
    def do_locate(self, img, index, update=0):
        ...
        return np.vstack((xl, xr)), elapsed
    ...
    def update_params(self, params):
        self.params = params
        # self.output_locate.params = params
